...
public class NodeGenerator : MonoBehaviour
{
    ...
    [SerializeField] private float nodeOffset = 16;
    ...
    public GameObject Prefab { get { return nodePrefab; } set { nodePrefab = value; } }
    ...
    private void Start()
    {
        roomGenerator.OnRoomsFinished.AddListener(DestroyNodes);
    }

    public void InitNodeGenerator()
    {
        nodesPlaced = new List<RoomNode>();
        nodeQueue = new Queue<RoomNode>();
    ...
    public void PlaceFirstNode()
    {
        ...
        GameObject topNode = Instantiate(nodePrefab, new Vector2(node.transform.position.x, node.transform.position.y + nodeOffset), Quaternion.identity);
        ...
        GameObject bottomNode = Instantiate(nodePrefab, new Vector2(node.transform.position.x, node.transform.position.y - nodeOffset), Quaternion.identity);
        ...
        GameObject rightNode = Instantiate(nodePrefab, new Vector2(node.transform.position.x + nodeOffset, node.transform.position.y), Quaternion.identity);
        ...
        GameObject leftNode = Instantiate(nodePrefab, new Vector2(node.transform.position.x - nodeOffset, node.transform.position.y), Quaternion.identity);
    ...
    private void PlaceNodeInRandomDiection(List<int> directions, GameObject node, int row, int col)
    {
        ...
        if (direction == 1)
        {
            GameObject newNode = Instantiate(nodePrefab, new Vector2(node.transform.position.x, node.transform.position.y + nodeOffset), Quaternion.identity);
        ...
        {
            GameObject newNode = Instantiate(nodePrefab, new Vector2(node.transform.position.x + nodeOffset, node.transform.position.y), Quaternion.identity);
            RoomNode rn = newNode.GetComponent<RoomNode>();
            nodeQueue.Enqueue(rn);
